# Univers Vivant — Documentation Complète du Projet

> IA émergente 2D avec terrain procédural, cerveaux neuronaux, sociétés et civilisations.
...
│   ├── _merged/
│   │   ├── contruire.png
│   │   ├── craftpix-net-211148-free-fantasy-chibi-female-sprites-pixel-art_enchantress_attack.png
│   │   ├── craftpix-net-211148-free-fantasy-chibi-female-sprites-pixel-art_knight_attack.png
│   │   ├── craftpix-net-211148-free-fantasy-chibi-female-sprites-pixel-art_musketeer_attack.png
...
│   │   │   │       ├── Tree2.png
│   │   │   │       └── Tree3.png
│   │   │   ├── Trees_shadow_source.png
│   │   │   ├── Trees_source.png
│   │   │   ├── Trees_texture_shadow_source.png
│   │   │   └── Trees_texture_shadows_dark_source.png
│   │   └── COUPON.png
...
## game/config.py  
*Constantes globales (GRID, TILE, couleurs...)*
...
## game/world.py  
*WorldGrid (tiles, items, feux, phéromones)*
...
## game/worldgen.py  
*Génération procédurale (fBm, biomes, pentes)*
...
## game/brain.py  
*Cerveau neuronal (Elman, REINFORCE)*
...
def think(brain: Brain, perception: Dict[str, Any]) -> Intention:
    ...
    Note : brain.py conserve ses poids internes (N_IN=95, N_OUT=15) — cette
    fonction ne fait queForward pass + échantillonnage d'action.
    """
...
## game/engine.py  
*Moteur : build_world, populate, place*
...
## game/renderer.py  
*Rendu (terrain, entités, nuit, pluie)*
...
## game/dashboard.py  
*Interface complète (panneaux, onglets)*
...
## game/simulation.py  
*Boucle de simulation (perception→action→conséquence)*
...
*Catalogue d'assets (découverte, sprites)*
...
## game/ui_kit.py  
*Widgets graphiques (boutons, jauges, etc.)*
